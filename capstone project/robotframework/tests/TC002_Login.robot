...
TC002 User 1 Login And Cart
    Login And Cart Flow    ${USERS}[0]

TC002 User 2 Login And Cart
    Login And Cart Flow    ${USERS}[1]

TC002 User 3 Login And Cart
    Login And Cart Flow    ${USERS}[2]

TC002 User 4 Login And Cart
    Login And Cart Flow    ${USERS}[3]

TC002 User 5 Login And Cart
    Login And Cart Flow    ${USERS}[4]
