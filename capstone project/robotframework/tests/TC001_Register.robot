...
TC001 User 1 Register
    Register Single User    ${USERS}[0]

TC001 User 2 Register
    Register Single User    ${USERS}[1]

TC001 User 3 Register
    Register Single User    ${USERS}[2]

TC001 User 4 Register
    Register Single User    ${USERS}[3]

TC001 User 5 Register
    Register Single User    ${USERS}[4]
